...
class BarChartSample1 extends StatefulWidget {
  ...
  final Color barBackgroundColor = Color(0xff0C0C0C);
  final Color barColor = Color(0xff2F2F2F);
  final Color touchedBarColor = Color.fromARGB(255, 226, 21, 65);
      ...
      barRods: [
        BarChartRodData(
          ...
          borderSide: isTouched
              ? BorderSide(color: Color(0xff0c0c0c))
